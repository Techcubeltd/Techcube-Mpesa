...
<html>
    ...
    <body class="skin-blue">
                        ...
                        <div class="col-md-3">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h4 class="box-title">Choose Teachers (Draggable Events)</h4>
                                </div>
                                <div class="box-body">
                                    <!-- the events -->
      ...
      echo "<select name='staff' class='external-event bg-green'>";
    for ($i = 0 ; $i < $no ; ++$i)
      {
      ...
      echo "</select><br/>";
      ?> </div>
                                        <div class='external-event bg-red'> <?php      require_once("../../connect.php");
          $statusQuery="select fullname from staff";
        $statusResult=queryMysql($statusQuery);
        $no = mysql_num_rows($statusResult);
      echo "<select name='staff' class='external-event bg-red'>";
    for ($i = 0 ; $i < $no ; ++$i)
      {
        $statusRow = mysql_fetch_row($statusResult);
        echo "<option value=$statusRow[0]>$statusRow[0]</option>";
      ...
      echo "</select><br/>";
      ?> </div>
                                        <div class='external-event bg-aqua'> <?php      require_once("../../connect.php");
          $statusQuery="select fullname from staff";
        $statusResult=queryMysql($statusQuery);
        $no = mysql_num_rows($statusResult);
      echo "<select name='staff' class='external-event bg-aqua'>";
    for ($i = 0 ; $i < $no ; ++$i)
      {
        $statusRow = mysql_fetch_row($statusResult);
        echo "<option value=$statusRow[0]>$statusRow[0]</option>";
      ...
      echo "</select><br/>";
      ?> </div>
                                        <div class='external-event bg-yellow'> <?php      require_once("../../connect.php");
          $statusQuery="select fullname from staff";
        $statusResult=queryMysql($statusQuery);
        $no = mysql_num_rows($statusResult);
      echo "<select name='staff' class='external-event bg-yellow'>";
    for ($i = 0 ; $i < $no ; ++$i)
      {
        $statusRow = mysql_fetch_row($statusResult);
        echo "<option value=$statusRow[0]>$statusRow[0]</option>";
      ...
      echo "</select><br/>";
      ?> </div>
                                        <div class='external-event bg-navy'> <?php      require_once("../../connect.php");
          $statusQuery="select fullname from staff";
        $statusResult=queryMysql($statusQuery);
        $no = mysql_num_rows($statusResult);
      echo "<select name='staff' class='external-event bg-navy'>";
    for ($i = 0 ; $i < $no ; ++$i)
      {
        $statusRow = mysql_fetch_row($statusResult);
        echo "<option value=$statusRow[0]>$statusRow[0]</option>";
      ...
      ?> </div>
                        ...
                        <div class="col-md-9">
                        <!--a class="btn btn-danger" type="submit" href="print.php" >Print Roster</a-->
                            <div class="box box-primary">                                
