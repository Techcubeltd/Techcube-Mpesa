...
$query_Products = "SELECT * from fine where status='$status' ";
...
//		$this->SetTextColor(0,0,255);
		...
		$this->Cell(200, 6,'Book Fines', 0, 0, 'C', 1);
		...
		$header=array('Barcode','StudentId','Amount','Status');
		$w=array(30,30,30,40);
		$this->Cell(30);
...
do {
	$pdf->Cell(30);
	$pdf->Cell(30, 6,$row_Products['bookcode'] ,1 , 0,'L');
	$pdf->Cell(30, 6,$row_Products['studentcode'] ,1 , 0,'L');
	$pdf->Cell(30, 6, $row_Products['amount'], 1, 0, 'L');
	$pdf->Cell(40, 6, $row_Products['status'], 1, 0, 'L');
