...
if ($_POST) {
	# code...
	$staffid=sanitizeString($_POST['adm']);
	$status=sanitizeString($_POST['status']);

$query_Products = "SELECT * from bookissue where studentcode='$staffid'  && status='$status' order by issuedate desc";
...
//		$this->SetTextColor(0,0,255);
		...
		$this->Cell(200, 6,'student book issues', 0, 0, 'C', 1);
