...
$query_Products = "SELECT * from bookissue where status='$status' && booktype='library' order by  issuedate desc";
...
//		$this->SetTextColor(0,0,255);
		...
		$this->Cell(200, 6,'library book issues', 0, 0, 'C', 1);
		...
		$header=array('Barcode','Id','Issue Date','Due Date','Booktype','Status');
