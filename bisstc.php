...
$duedate=sanitizeString($_POST['duedate']);
	...
	# code...
	$query="INSERT INTO bookissue(barcode,studentcode,issuedate,duedate,issuedby,issuedto,booktype)VALUES('$bcode','$scode','$isdate','$duedate','$user','staff','course')";
mysql_query($query);
...
echo "<a href='staffissues.php' class='btn btn-primary btn-xs' type='submit'>View Issued course Books</a> ";
