...
$query_Products = "SELECT * from bookissue where studentcode='$staffid' && booktype='course' && status='$status' order by issuedate desc";
...
//		$this->SetTextColor(0,0,255);
		...
		$this->Cell(200, 6,'staff book issues', 0, 0, 'C', 1);
