...
$_REQUEST['user'];
$scode=$_REQUEST['id'];
$query_Products = "SELECT * from bookissue where studentcode='$scode' ";
$query2 = "SELECT * staff where employeecode='$scode' ";
...
//		$this->SetTextColor(0,0,255);
		...
		$this->Cell(200, 6,'Student Name ................................  issued books', 0, 0, 'C', 1);
		...
		$header=array('Book Code','Date Issued','Due Date','Status');
		$w=array(30,30,30,30);
		$this->Cell(30);
...
do {
	...
	$pdf->Cell(30, 6, $row_Products['duedate'], 1, 0, 'L');
	$pdf->Cell(30, 6, $row_Products['status'], 1, 0, 'L');
